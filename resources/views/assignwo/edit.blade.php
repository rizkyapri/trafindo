    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div>
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('assignwo.update', $assignData->id) }}" method="POST"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    {{-- <select class="form-select @error('OprID') is-invalid @enderror"
                                        aria-label="OprID" id="OprID" name="OprID">
                                        <option selected disabled>- Choose Employee -</option>
                                        @foreach ($data as $employee)
                                            <option value="{{ $employee['id'] }}">{{ $employee['WONumber'].$employee['OprNumber'] }}</option>
                                        @endforeach
                                    </select> --}}
                                </div>
                                @error('OprID')
