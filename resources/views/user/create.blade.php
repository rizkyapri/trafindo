                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" id="basic-icon-default-fullname"
                                        name="username" placeholder="Input Username" aria-label="John Doe"
                                        aria-describedby="basic-icon-default-fullname2" value="{{ old('username') }}" />
                                </div>
                                @error('username')
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-company2" class="input-group-text">
                                        <i class="bx bx-key"></i></span>
                                    <input type="password" id="basic-icon-default-company" class="form-control"
                                        placeholder="Password" aria-label="ACME Inc." name="password"
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <select class="form-select @error('andoncat') is-invalid @enderror"
                                        ...
                                        <option selected disabled>- Choose andon category -</option>
